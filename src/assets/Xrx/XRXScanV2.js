...
*/
export function xrxScanV2GetInterfaceVersion( url, callback_success, callback_failure, timeout, async )
{
    if((url == null) || (url == ""))
        url = "http://127.0.0.1";
...
*/
export function xrxScanV2ParseGetInterfaceVersion(response) 
{
...
*           		response or comm error beginning with "FAILURE" if async == false.
*/
export function xrxScanV2InitiateScanJob( url, scanV2JobTicket, callback_success, callback_failure, timeout, async, token )
{
    if((url == null) || (url == ""))
        url = "http://127.0.0.1";
...
* @return	string	    xml request
*/
export function xrxScanV2InitiateScanJobRequest(scanV2JobTicket, token)
{
	var tokenTag = '';
...
* @return {string}  jobID
*/
export function xrxScanV2ParseInitiateScanJob( response )
{
...
*           		response or comm error beginning with "FAILURE" if async == false.
*/
export function xrxScanV2InitiateScanJobWithTemplate( url, templateName, isPool, token, callback_success, callback_failure, timeout, async )
{
    if((url == null) || (url == ""))
        url = "http://127.0.0.1";
	var sendUrl = url + XRX_SCANV2_PATH;
...
* @return {string} 	xml request
*/
export function xrxScanV2InitiateScanJobWithTemplateRequest( templateName, isPool, token )
{
	return	XRX_SOAPSTART
...
* @return {string} 	jobID
*/
export function xrxScanV2ParseInitiateScanJobWithTemplate( response )
{
